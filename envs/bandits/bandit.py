...
class BanditEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # Use the environment's own RNG (set up by gymnasium via reset(seed=...))
        # instead of the global np.random state, per the Gymnasium API.
    ...
    def reset(self, *, seed=None, options=None):
        # gymnasium's Env.reset(seed=...) initializes self.np_random for us.
